<template>
  <modal @close="$emit('close')" @submit="create">
    ...
    <template v-slot:content>
      <div class="inputs">
        ...
        <toggle v-model="isScenario" class="inputs-margin" label="Сценарий" />
...
export default {
  ...
  mounted() {
    this.getScenarios().catch((_error) => {});
  },
  validations: {
    form: {
      name: {
